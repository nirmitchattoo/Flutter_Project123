...
class TeacherBasicPage extends StatefulWidget {
  TeacherBasicPage({required Key key, required this.auth, required this.userId, required this.logoutCallback})
      : super(key: key);
...
class _TeacherBasicPageState extends State<TeacherBasicPage> {
  ...
  Widget checkInput() {
    return Padding(
      ...
      child: new TextFormField(
        ...
        return "Enter Class First";
        },

        onSaved: (value) => check = value.toString(),
      ),
    );
  }
  ...
  Widget subjCodeInput() {
    return Padding(
      ...
      child: new TextFormField(
        ...
        onSaved: (value) => classname = value.toString(),
      ),
    );
  }
  ...
  Widget dateInput() {
    ...
    return "Enter date in dd.mm.yy format";
      ...
      onSaved: (value) => date = value.toString(),
      ),
    );
  }
  ...
  Widget codeInput() {
    ...
    onSaved: (value) => secretcode = value.toString(),
