...
class StudentHomePage extends StatefulWidget {
  StudentHomePage({required Key key, required this.auth, required this.userId, required this.logoutCallback})
      : super(key: key);
...
class _StudentHomePageState extends State<StudentHomePage> {
  ...
  Future<void> updateDatabase() async {
    ...
    var teacherData = await FirebaseFirestore.instance.collection("users")
        .doc(teacherUID)
        .collection(classname)
        .doc(date)
        .get();
